#!/usr/bin/env python3
"""
Day 5(보험사 사기탐지 온보딩) / Day 10(신용평가 E2E) 용 sklearn 이진분류 모델.
...
서빙: day03-serving-sklearn(동일 sklearn ServingRuntime), Day5 Blue-Green/Gateway API로 확장.
...
OUTDIR = os.path.join(os.getcwd(), "fraud")
