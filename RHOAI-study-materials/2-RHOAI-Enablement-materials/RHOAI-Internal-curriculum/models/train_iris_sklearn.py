#!/usr/bin/env python3
"""
Day 3(KServe 기본 배포) / Day 6(Workbench RandomForest) 용 sklearn 모델.

curriculum v1.0:
  - Day 3: "사전훈련 scikit-learn 모델 준비" -> ServingRuntime + InferenceService
...
서빙: manifests/day03-serving-sklearn/ 참조 (sklearn ServingRuntime + ISVC).
