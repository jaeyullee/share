#!/usr/bin/env python3
"""
Day 4(멀티프레임워크) — PyTorch(MNIST) 모델.

curriculum v1.0 Day 4: "PyTorch(MNIST) 모델 배포". CPU에서 1~2 epoch면 충분(경로 체득용).
TorchServe(.mar) 대신, KServe RawDeployment에서 쓰기 쉬운 경로 2가지를 모두 출력:
