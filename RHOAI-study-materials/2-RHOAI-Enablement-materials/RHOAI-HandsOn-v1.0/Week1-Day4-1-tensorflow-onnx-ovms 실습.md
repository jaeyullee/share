...
cd /tmp
rm -rf /tmp/wheelhouse-cp39-day4-tf-onnx
mkdir -p /tmp/wheelhouse-cp39-day4-tf-onnx
...
rm -rf /tmp/day04-tf-onnx-pypi-upload-venv
/usr/bin/python3 -m venv /tmp/day04-tf-onnx-pypi-upload-venv
source /tmp/day04-tf-onnx-pypi-upload-venv/bin/activate
...
python -m pip download \
  ...
  -d /tmp/wheelhouse-cp39-day4-tf-onnx
...
twine upload \
  ...
  /tmp/wheelhouse-cp39-day4-tf-onnx/*

## 내부 nexus 이용해서 모델 생성
deactivate 2>/dev/null || true
cd /tmp/python3
rm -rf /tmp/python3/.venvs/day04-tf-onnx
mkdir -p /tmp/python3/.venvs
/usr/bin/python3 -m venv /tmp/python3/.venvs/day04-tf-onnx
source /tmp/python3/.venvs/day04-tf-onnx/bin/activate
