...
rm -rf /tmp/day04-pytorch-pypi-upload-venv
/usr/bin/python3 -m venv /tmp/day04-pytorch-pypi-upload-venv
source /tmp/day04-pytorch-pypi-upload-venv/bin/activate
...
deactivate 2>/dev/null || true
cd /tmp/python3
rm -rf /tmp/python3/.venvs/day04-pytorch
mkdir -p /tmp/python3/.venvs
/usr/bin/python3 -m venv /tmp/python3/.venvs/day04-pytorch
source /tmp/python3/.venvs/day04-pytorch/bin/activate
  ...
  "inputs": [
    {
      ...
      "shape": [1, 1, 28, 28],
      "datatype": "FP32",
      "data": [$(python -c 'print(",".join(["0.0"] * 784))')]
    }
  ]
}
EOF
