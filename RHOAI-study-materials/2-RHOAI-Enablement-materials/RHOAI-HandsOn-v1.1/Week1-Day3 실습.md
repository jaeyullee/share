...
rm -rf /tmp/day03-pypi-upload-venv
/usr/bin/python3 -m venv /tmp/day03-pypi-upload-venv
source /tmp/day03-pypi-upload-venv/bin/activate
...
deactivate 2>/dev/null || true
cd /tmp/python3
rm -rf /tmp/python3/.venvs/day03
mkdir -p /tmp/python3/.venvs
/usr/bin/python3 -m venv /tmp/python3/.venvs/day03
source /tmp/python3/.venvs/day03/bin/activate
