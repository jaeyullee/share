...
rm -rf /tmp/day04-tf-savedmodel-pypi-upload-venv
/usr/bin/python3 -m venv /tmp/day04-tf-savedmodel-pypi-upload-venv
source /tmp/day04-tf-savedmodel-pypi-upload-venv/bin/activate
...
deactivate 2>/dev/null || true
cd /tmp/python3
rm -rf /tmp/python3/.venvs/day04-tf-savedmodel
mkdir -p /tmp/python3/.venvs
/usr/bin/python3 -m venv /tmp/python3/.venvs/day04-tf-savedmodel
source /tmp/python3/.venvs/day04-tf-savedmodel/bin/activate
