...
> 사전 활성화: [Week5 Step 3](Week5-Step3%20실습.md)의 source/GitOps 저장소를 준비하고 두 저장소에 같은 Gitea PAT로 접근할 수 있어야 한다.
...
stringData:
  type: git
  url: https://gitea.apps.sno.ocp422.com/rhoai-lab/week5-llm-gitops.git
  username: <GITEA_ID>
  password: <GITEA_PAT>
  insecure: "true"
EOF
