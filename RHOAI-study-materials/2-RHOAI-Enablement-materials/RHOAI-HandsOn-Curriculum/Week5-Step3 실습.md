...
> 사전 활성화: [Week5 Step 2](Week5-Step2%20실습.md)를 완료하고 Gitea에 저장소를 만들 수 있어야 한다.
...
| 저장소 | 용도 |
|---|---|
| `rhoai-lab/week5-llm-source` | dataset, 훈련 코드, Containerfile, KFP DSL |
| `rhoai-lab/week5-llm-gitops` | KFP CR과 staging/production serving 선언 |
...
git remote add origin \
  https://gitea.apps.sno.ocp422.com/rhoai-lab/week5-llm-source.git
...
git branch -M main
git remote add origin \
  https://gitea.apps.sno.ocp422.com/rhoai-lab/week5-llm-gitops.git
git push -u origin main
```
