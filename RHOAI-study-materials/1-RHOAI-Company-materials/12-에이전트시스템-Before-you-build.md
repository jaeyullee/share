...
> 상위 맥락: [00-인덱스](00-인덱스.md) / 경영진 관점은 [13-에이전트AI-경영진가이드](13-에이전트AI-경영진가이드.md)
...
- 관련 vault: [02-AI-에이전트-도구호출-프롬프트패턴](../4-etc-AI-materials/02-AI-에이전트-도구호출-프롬프트패턴.md), [[AI-에이전트-환경-구축기]].
